...
<nav>
    <ul>
        <li>
            <a href="Controlleur?todo=ajouterCompetences">
                vous souhaitez vous rajouter une competences ?
            </a>
        </li>

        <li>
            <a href="Controlleur?todo=creerprojet">
                creer un projet
            </a>
        </li>
        ...
        <li>
            <a href="Controlleur?todo=creerutilisateur">
        ...
        <li>
            <a href="Controlleur?todo=deconnexion">
                deconnexion
            </a>
        </li>
